...
class HandRank {
    ...
    static compareRank(rankA, rankB) {
...
class Poker {
    ...
    getSeat(seat = null) {
        ...
        if (seat == null) {
            ...
            return this.players[seat] != null ? seat : null;
    }
    rewardWinners() {
        var winningPlayers = [];
        var winningRanks = [];
